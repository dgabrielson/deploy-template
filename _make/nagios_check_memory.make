...
nagios_check_memory.evt: SCRIPT_NAME = $(shell basename $<)
nagios_check_memory.evt: ../_nrpe/check_mem.pl | fabadmin.evt	## Ensure remote system can do NRPE checks for memory
	ping -qc 1 $(FQDN)
