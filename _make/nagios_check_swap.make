...
nagios_check_swap.evt: SCRIPT_NAME = $(shell basename $<)
nagios_check_swap.evt: ../_nrpe/check_swap.py | fabadmin.evt	## Ensure remote system can do NRPE checks for memory
	ping -qc 1 $(FQDN)
