...
nagios_check_mdstat.evt: SCRIPT_NAME = $(shell basename $<)
nagios_check_mdstat.evt: ../_nrpe/nagios_check_mdstat.sh | fabadmin.evt	## Ensure remote system can do softraid checks
	ping -qc 1 $(FQDN)
