...
nagios_check_x224.evt: SCRIPT_NAME = $(shell basename $<)
nagios_check_x224.evt: ../_nrpe/check_x224 | fabadmin.evt	## Ensure remote system can do NRPE checks for memory
	ping -qc 1 $(FQDN)
