...
nagios_check_printer.evt: SCRIPT_NAME = $(shell basename $<)
nagios_check_printer.evt: ../_nrpe/check_snmp_printer | fabadmin.evt	## Ensure remote system can do NRPE checks for memory
	ping -qc 1 $(FQDN)
