...
nagios_check_idrac.evt: SCRIPT_NAME = $(shell basename $<)
nagios_check_idrac.evt: ../_nrpe/check_idrac | fabadmin.evt	## Ensure remote system can do NRPE checks for memory
	ping -qc 1 $(FQDN)
