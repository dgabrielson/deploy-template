...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="Generate a random name for new hardware")

    parser.add_argument('-p', '--purpose', action='store_true',
                   help='Describe purpose names as well (use in cnames.conf for hardware)')
    args = parser.parse_args()
    if args.purpose:
        print('''
# Recommended purpose names #

Source: https://mnx.io/blog/a-proper-server-naming-scheme/
...
* cnm - Container manager
* cnw - Container worker
* web – Web Server
